  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="/">
                            <img src="{{ asset('landing/assets/img/logo.png') }}" alt="" width="30">

            <span class="text-1000 fs-1 ms-2 fw-medium">Banque de &nbsp;</span>
            <span class="fw-bold text-danger">Sang</span>
          </a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
               ...
               <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                    ...
                    @else
                      ...
                      <li class="nav-item"><a class="nav-link fw-medium active" href="{{ route('login') }}">Login</a></li>

                        @if (Route::has('register'))
                            <form action="{{ route('register') }}" method="GET" class="ps-lg-5">
      ...
      <section class="py-0" id="home">
        ...
        <div class="container position-relative">
          <div class="row align-items-center py-8">
            <div class="col-md-5 col-lg-6 order-md-1 text-center text-md-end"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/mobile.png') }}" width="350" alt="" /></div>
            <div class="col-md-7 col-lg-6 text-center text-md-start">
                <span class="badge bg-light rounded-pill text-dark align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-75 w-sm-50 w-md-75 w-xl-50 mb-3">#1 Editiors Choice App of 2020<img class="img-fluid float-start me-3" src="{{ asset('landing/assets/img/illustrations/arrow-right.png') }}" alt=""/>
                </span>

                <div class="pt-3">
                <form>
                  <div class="input-group w-xl-75 w-xxl-50 d-flex flex-end-center">
                    <input class="form-control rounded-pill shadow-lg border-0" id="formGroupExampleInput" type="text" placeholder="Seacrh by skill, company and job">
                    <img class="input-box-icon me-2" src="{{ asset('landing/assets/img/search.png') }}" width="30" alt=""></div>
                </form>
              </div>
      ...
      <section class="py-7">
        ...
        <div class="container">
          ...
          <div class="row align-items-center justify-content-center justify-content-lg-around">
            <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img src="{{ asset('landing/assets/img/gallery/company-1.png') }}" alt="" /></div>
            <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img src="{{ asset('landing/assets/img/gallery/company-2.png') }}" alt="" /></div>
            <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img src="{{ asset('landing/assets/img/gallery/company-3.png') }}" alt="" /></div>
            <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img src="{{ asset('landing/assets/img/gallery/company-4.png') }}" alt="" /></div>
            <div class="col-6 col-sm-4 col-md-4 col-lg-2 px-md-0 mb-5 mb-lg-0 text-center"><img src="{{ asset('landing/assets/img/gallery/company-1.png') }}" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section class="py-5" id="features">
        <div class="container-lg">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-md-0 text-center text-md-start"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/feature-bg.png') }}" width="550" alt="" /></div>
            <div class="col-md-7 col-lg-6 px-sm-5 px-md-0">
              ...
              <div class="d-flex align-items-center mb-5">
                <div><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/fast-performance.png') }}" width="90" alt="" /></div>
                <div class="px-4">
              ...
              <div class="d-flex align-items-center mb-5">
                <div><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/prototype.png') }}" width="90" alt="" /></div>
                <div class="px-4">
              ...
              <div class="d-flex align-items-center mb-5">
                <div><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/vector.png') }}" width="90" alt="" /></div>
                <div class="px-4">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 col-lg-3 offset-lg-1 mb-4">
              <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/automatic.png') }}" width="90" alt="" /></div>
              <h5 class="fw-bold text-danger">Fast performance</h5>
              <p class="mt-2 mb-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
            </div>
            <div class="col-md-4 col-lg-3 offset-lg-1 mb-4">
              <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/network.png') }}" width="90" alt="" /></div>
              <h5 class="fw-bold text-primary">Prototyping</h5>
              <p class="mt-2 mb-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
            </div>
            <div class="col-md-4 col-lg-3 offset-lg-1 mb-4">
              <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/rewards.png') }}" width="90" alt="" /></div>
              <h5 class="fw-bold text-success">Vector Editing</h5>
              <p class="mt-2 mb-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
            </div>
          </div>
      ...
      <section class="py-6">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="{{ asset('landing/assets/img/illustrations/call-to-action.png') }}" width="550" alt="" /></div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{ asset('landing/assets/img/illustrations/app.png') }}" width="90" alt="" />
            ...
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{ asset('landing/assets/img/illustrations/time-award.png') }}" width="90" alt="" />
                <h5 class="fw-bold">10 Times Award</h5>
                <p class="mb-md-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{ asset('landing/assets/img/illustrations/cloud.png') }}" width="90" alt="" />
                <h5 class="fw-bold">Cloud Storage</h5>
                <p class="mb-md-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{ asset('landing/assets/img/illustrations/customization.png') }}" width="90" alt="" />
                <h5 class="fw-bold">Customization</h5>
                <p class="mb-md-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{ asset('landing/assets/img/illustrations/ux.png') }}" width="90" alt="" />
                <h5 class="fw-bold">UX Planning</h5>
                <p class="mb-md-0">Get your blood tests delivered at home collect a sample from the news your blood tests.</p>
              </div>
            </div>
            <div class="col-md-4 mb-6">
              <div class="text-center px-lg-3"><img class="img-fluid mb-3" src="{{ asset('landing/assets/img/illustrations/support.png') }}" width="90" alt="" />
      ...
      <section class="py-6">
        ...
        <div class="container">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-md-5 order-md-1 text-center text-md-start"><img class="img-fluid mb-4" src="{{ asset('landing/assets/img/illustrations/ultimate-feature.png') }}" alt="" /></div>
              <div class="col-md-6 text-center text-md-start">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/app.png') }}" width="90" alt="" /></div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/ux.png') }}" width="90" alt="" /></div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/cloud.png') }}" width="90" alt="" /></div>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <div class="py-4"><img class="img-fluid" src="{{ asset('landing/assets/img/illustrations/support.png') }}" width="90" alt="" /></div>
      ...
      <section class="py-8" id="testimonial">
        <div class="container-lg">
          <div class="row flex-center">
            <div class="col-sm-10 col-md-5 col-lg-5 order-md-0 text-center text-md-start"><img class="img-fluid mb-4" src="{{ asset('landing/assets/img/illustrations/testimonial.png') }}" alt="" /></div>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="10000">
                    <div class="row h-100">
                      ...
                      <div class="col-xl-6 pt-4 d-flex d-sm-block flex-center">
                        <div class="d-flex align-items-md-center"><img class="img-fluid me-4 me-md-3 me-lg-4" src="{{ asset('landing/assets/img/gallery/user.png') }}" width="100" alt="" />
                  ...
                  <div class="carousel-item" data-bs-interval="2000">
                    <div class="row h-100">
                      ...
                      <div class="col-xl-6 pt-4 d-flex d-sm-block flex-center">
                        <div class="d-flex align-items-md-center"><img class="img-fluid me-4 me-md-3 me-lg-4" src="{{ asset('landing/assets/img/gallery/user-1.png') }}" width="100" alt="" />
                          <div class="w-lg-50 my-3">
                  ...
                  <div class="carousel-item">
                    <div class="row h-100">
                      ...
                      <div class="col-xl-6 pt-4 d-flex d-sm-block flex-center">
                        <div class="d-flex align-items-md-center"><img class="img-fluid me-4 me-md-3 me-lg-4" src="{{ asset('landing/assets/img/gallery/user-2.png') }}" width="100" alt="" />
                          <div class="w-lg-50 my-3">
      ...
      <section class="py-6">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 order-md-1 text-center text-md-start z-index-2 cta-image"><img class="img-fluid mb-4 mb-md-0" src="{{ asset('landing/assets/img/illustrations/cta.png') }}" width="850" alt="" /></div>
            <div class="col-md-7 col-lg-5 text-center text-md-start">
              ...
              <div class="d-flex justify-content-center d-md-inline-block"><a class="pe-2 pe-sm-3 pe-md-4" href="!#"><img src="{{ asset('landing/assets/img/illustrations/google-play.png') }}" width="160" alt="" /></a><a href="!#"><img src="{{ asset('landing/assets/img/illustrations/app-store.png') }}" width="160" alt="" /></a></div>
            </div>
          </div>
        </div>
      </section>
